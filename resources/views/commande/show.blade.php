    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <form method="post" action="{{route('send.commande')}}">
            ...
            <div class="form-group">
                <label for="exampleInputEmail1">Numero de téléphone au cas ou</label>
                <input type="text" name="tel" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Votre téléphone 0600006600">
            </div>
